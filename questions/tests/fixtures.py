...
class CreateDataMixin:
    ...
    def setUpClass(cls):
        ...
        cls.question = Question.objects.create(
            author=cls.user, title="Title", description="Content"
        )
        cls.answer_1 = Answer.objects.create(
            author=cls.user, question=cls.question, description="Content 1"
        )
        cls.answer_2 = Answer.objects.create(
            author=cls.user, question=cls.question, description="Content 2"
        )
    ...
    def create_question(cls, user=None):
        ...
        question = Question.objects.create(
            ...
            description=md5(urandom(10)).hexdigest(),
        )
        return question
